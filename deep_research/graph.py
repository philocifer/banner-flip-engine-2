...
def human_feedback(state: ReportState, config: RunnableConfig) -> Command[Literal["generate_report_plan","build_section_with_web_research"]]:
    ...
    feedback = True # Bypassing the interrupt for now
...
def write_section(state: SectionState, config: RunnableConfig) -> Command[Any]:
...
def compile_final_report(state: ReportState):
    ...
    return {"final_report": all_sections, "messages": [HumanMessage(content=all_sections, name="Final Report")]}
...
async def store_research_chain(message: str):
    initial_state = {"topic": message, "messages": [HumanMessage(content=message, name="User")]}
